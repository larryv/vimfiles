" mbyte_opts/0xB4_middle_dot.vim
" ------------------------------
"
...
" Modify listchars to use octet 0xB4/0264/180, which some encodings map
...
" Affects writes only.  Read with ':edit ++enc=8bit-nextstep' if necessary.
" vim: set fileencoding=8bit-nextstep:
